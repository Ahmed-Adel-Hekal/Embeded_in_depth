...
/* Port C */
# define DIO_U8_PC0_INITIAL_VALUE                 DIO_u8_INITIAL_HIGH
# define DIO_U8_PC1_INITIAL_VALUE				  DIO_u8_INITIAL_HIGH
# define DIO_U8_PC2_INITIAL_VALUE                 DIO_u8_INITIAL_HIGH
# define DIO_U8_PC3_INITIAL_VALUE                 DIO_u8_INITIAL_HIGH
